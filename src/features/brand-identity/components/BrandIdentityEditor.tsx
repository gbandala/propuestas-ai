...
export function BrandIdentityEditor({ initial, onSave }: BrandIdentityEditorProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-500">
            Define colores, tipografia, logo y tono visual. Este documento se usa en todas las piezas generadas.
          </p>
        </div>
